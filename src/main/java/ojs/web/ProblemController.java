...
public String submit(@Valid @ModelAttribute("problems") Problems problems, BindingResult result, ModelMap model)
{
//String loc="/home/sahriar/Desktop/ojs/";
    String loc="../Desktop/";
  //  Users users= (Users) SecurityContextHolder.getContext().getAuthentication().getDetails();

    //problems.setUsers(users);
